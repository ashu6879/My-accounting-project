...
const CategoryList = () => {
  ...
  const fetchClients = async () => {
    try {
      const response = await fetch(`http://ec2-13-234-31-37.ap-south-1.compute.amazonaws.com:8181/clientcategories?page=${page}&limit=${limit}&search=${searchTerm}`);
      if (!response.ok) {
  ...
  const handleDelete = async () => {
    try {
      const response = await fetch(`http://ec2-13-234-31-37.ap-south-1.compute.amazonaws.com:8181/clientcategories/${clientToDelete._id}`, {
        method: 'DELETE',
      });
  ...
  const handleUpdate = async () => {
    try {
      const response = await fetch(`http://ec2-13-234-31-37.ap-south-1.compute.amazonaws.com:8181/clientcategories/${clientToUpdate._id}`, {
        method: 'PUT',
        headers: {
