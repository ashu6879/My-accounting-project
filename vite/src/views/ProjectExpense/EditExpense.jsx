...
const EditProjectExpense = () => {
    ...
    const fetchExpensesAndProjects = useCallback(async () => {
        ...
        try {
            const expenseResponse = await fetch('http://ec2-13-233-199-35.ap-south-1.compute.amazonaws.com:8181/expense');
            ...
            const projectResponse = await fetch('http://ec2-13-233-199-35.ap-south-1.compute.amazonaws.com:8181/projects');
    ...
    const handleUpdate = async () => {
        try {
            const updatePromises = updateDetails.map(expense =>
                fetch(`http://ec2-13-233-199-35.ap-south-1.compute.amazonaws.com:8181/Expense/${expense._id}`, {
                    method: 'PUT',
                    headers: {
