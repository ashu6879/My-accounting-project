...
const CategoriesList = () => {
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch(
        `http://ec2-13-233-96-56.ap-south-1.compute.amazonaws.com:8181/projectcategories?page=${page}&limit=${limit}&search=${encodeURIComponent(search)}`
      );
      if (!response.ok) {
  ...
  const handleDelete = async () => {
    try {
      const response = await fetch(`http://ec2-13-233-96-56.ap-south-1.compute.amazonaws.com:8181/projectcategories/${categoryToDelete._id}`, {
        method: 'DELETE',
      });
  ...
  const handleUpdate = async () => {
    try {
      const response = await fetch(`http://ec2-13-233-96-56.ap-south-1.compute.amazonaws.com:8181/projectcategories/${categoryToUpdate._id}`, {
        method: 'PUT',
        headers: {
