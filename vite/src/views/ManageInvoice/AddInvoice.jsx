...
const GenerateInvoice = () => {
  ...
  const fetchCurrencies = async () => {
    try {
      const response = await fetch('http://ec2-13-234-31-37.ap-south-1.compute.amazonaws.com:8181/currencies');
      const data = await response.json();
      setCurrencies(data);
    } catch (error) {
  ...
  const handleClientChange = async (event) => {
    ...
    if (client) {
      ...
      try {
        const response = await fetch(`http://ec2-13-234-31-37.ap-south-1.compute.amazonaws.com:8181/getProjectByClientID/${clientID}`);
        const data = await response.json();
        setProjects(data);
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Create the invoice
      const createResponse = await fetch('http://ec2-13-234-31-37.ap-south-1.compute.amazonaws.com:8181/invoices', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      const invoicesResponse = await fetch('http://ec2-13-234-31-37.ap-south-1.compute.amazonaws.com:8181/invoices');
      ...
      await Promise.all(invoiceItems.map(async (item) => {
        ...
        const itemResponse = await fetch('http://ec2-13-234-31-37.ap-south-1.compute.amazonaws.com:8181/invoiceItem', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
