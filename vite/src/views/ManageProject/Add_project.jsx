...
const AddProject = () => {
  ...
  useEffect(() => {
    const fetchClientsAndCategories = async () => {
      try {
        const clientResponse = await fetch('http://ec2-35-154-230-63.ap-south-1.compute.amazonaws.com:8181/clients');
        ...
        const categoryResponse = await fetch('http://ec2-35-154-230-63.ap-south-1.compute.amazonaws.com:8181/projectcategories');
