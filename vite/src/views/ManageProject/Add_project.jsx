...
const AddProject = () => {
  ...
  useEffect(() => {
    const fetchClientsAndCategories = async () => {
      try {
        const clientResponse = await fetch('http://ec2-13-233-199-35.ap-south-1.compute.amazonaws.com:8181/clients');
        ...
        const categoryResponse = await fetch('http://ec2-13-233-199-35.ap-south-1.compute.amazonaws.com:8181/projectcategories');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://ec2-13-233-199-35.ap-south-1.compute.amazonaws.com:8181/projects', {
        method: 'POST',
        headers: {
