...
const AuthRegister = ({ ...others }) => {
  ...
  const handleSubmit = async (values, { setSubmitting, setErrors }) => {
    try {
      const response = await fetch('http://ec2-13-233-251-109.ap-south-1.compute.amazonaws.com:8181/signup', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          username: values.email, // Assuming email is used as username
          password: values.password,
          firstName: values.fname, // Include first name
          lastName: values.lname, // Include last name
        }),
      });
