...
export const generatePDF = async (invoice) => {
    try {
        ...
        const invoiceResponse = await fetch(`http://ec2-13-233-199-35.ap-south-1.compute.amazonaws.com:8181/getInvoiceItemByInvID/${invoice.invID}`);
        ...
        if (invoice.currencyID) {
            ...
            const currenciesResponse = await fetch(`http://ec2-13-233-199-35.ap-south-1.compute.amazonaws.com:8181/currencies/${invoice.currencyID}`);
