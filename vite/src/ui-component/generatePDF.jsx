...
export const generatePDF = async (invoice) => {
    try {
        ...
        const invoiceResponse = await fetch(`http://ec2-52-66-244-210.ap-south-1.compute.amazonaws.com:8181/getInvoiceItemByInvID/${invoice.invID}`);
        ...
        if (invoice.currencyID) {
            ...
            const currenciesResponse = await fetch(`http://ec2-52-66-244-210.ap-south-1.compute.amazonaws.com:8181/currencies/${invoice.currencyID}`);
